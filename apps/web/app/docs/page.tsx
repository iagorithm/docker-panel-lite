...
export default function DocsOverviewPage() {
  return <main className="docs-article">
    <header className="docs-article-header"><p className="docs-breadcrumb">Documentation / Overview</p><h1>worqer.app documentation</h1><p>Learn how to connect a Docker host and take an application from a Git repository to a running deployment.</p></header>
