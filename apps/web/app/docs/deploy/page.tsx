...
export default function CompleteDeploymentPage() {
  return <main className="docs-article">
    ...
    <section id="status"><h2>Deployment states</h2><table><thead><tr><th>Status</th><th>Meaning</th></tr></thead><tbody><tr><td>queued</td><td>Waiting for the target worker.</td></tr><tr><td>leased / running</td><td>The worker is executing Git or Docker operations.</td></tr><tr><td>completed</td><td>The worker finished and published resource updates.</td></tr><tr><td>failed</td><td>The event contains the actionable worker error.</td></tr></tbody></table></section>
