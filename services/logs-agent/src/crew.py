...
""".strip()
    ...
    if github.allow_writes:
        ...
        output = (f"Brief English Markdown, maximum 220 words, with exactly: Confirmed error, Minimal fix {change_status}, Exact code change, Complete pending proposal. State paths and distinguish changed code from recommendations." if markdown else f"English only, maximum 150 words: confirmed error, minimal fix {change_status}, exact path/change, and complete remaining proposal clearly marked as not applied.")
        ...
        output = ("Brief English Markdown, maximum 220 words, with exactly: Confirmed error, Cause in code, Complete proposal, Safe minimal fix. Include affected paths and clearly separate required correction from optional improvements." if markdown else "English only, maximum 150 words: confirmed error, code cause, complete evidence-based proposal, and safest minimal fix. Distinguish required from optional work.")
